...
import net.wanho.util.CommonUtil;
...
public class UserContextLoaderListener implements ServletContextListener {

    /**
     * 日志记录器
     */
    private Logger log = Logger.getLogger(UserContextLoaderListener.class);


    @Override
    public void contextInitialized(ServletContextEvent servletContextEvent) {
        log.debug("[contextDestroyed] --开始-- WEB项目启动，加载配置数据");
        CommonUtil.APPLICATION_CONTEXT = WebApplicationContextUtils.getWebApplicationContext(servletContextEvent.getServletContext());
