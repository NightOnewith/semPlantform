...
public class CommonUtil {
    ...
    public static ResourceBundle rsb = ResourceBundle.getBundle("user");

    public static ThreadPoolExecutor threadPool;

    //结算专用线程池，其他功能请勿使用
    public static ThreadPoolExecutor settlethreadPool;
     ...
     * @return
     */
    public static boolean isEntityId(Long id){
        return id!=null && id>0;
    }
            ...
            for (int i = 0; i < descriptors.length; i++) {
                ...
                if (!"class".equals(name)) {
                   ...
                   if(val!=null){
                       ...
                       log.debug(val.getClass().getSimpleName().toLowerCase());
                       if(val.getClass().getSimpleName().toLowerCase().equals("date")){
                           Date dt = (Date)val;
                           value=  DateFormatUtils.format(dt, "yyyy-MM-dd HH:mm:ss");
                       }
                       String msg = String.format("CommonUtil.beanToMap Method==>key:%s & value:%s",name,value);
                       log.debug(msg);
